...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $insert_purchase_import_query = "INSERT IGNORE INTO purchaseOrder (PONumber, PODate, POSupplier, POShipment, POTerm, POPayment, POOrigin, POShippingMarks, PORemarks, POStatus, POtype, POCurrency, InsertBy, InsertDt) VALUES ('$purchase_order_number','$purchase_order_date', '$purchase_order_supplier', '$purchase_order_shipment', '$purchase_order_term', '$purchase_order_payment','$purchase_order_origin','$purchase_order_shippingmarks','$purchase_order_remarks', '$purchase_order_status', '$purchase_order_type', '$purchase_order_currency', '$insert_by', '$currentDateTimeString');";
